    ...
    <div className="profile">
      ...
      <div className="recent-interests">
        ...
        <div className="interests-list">
          {['Automation', 'Kpop', 'Artificial Intelligence', 'Machine Learning', 'Food', 'LLM Technology', 'Social Impact', 'Animals', 'Embroidery', 'Robotics', 'Neurotech', 'Plushies', 'Leetcode' ].map((interest, index) => (
